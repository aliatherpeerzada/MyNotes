...
<View style={[style.notesContainer]}>
            ...
            <View Style={style.headingContainer}>
                 ...
                 <Text style={style.heading}>My Notes...</Text>
                    ...
                    <TouchableOpacity style={[style.button,]} onPress={()=>navigation.navigate("DeletedNotes")}>
            ...
            <View style={style.searchContainer}>
             ...
             <TouchableOpacity
             onPress={()=>search()}
                style={[style.searchButton,{width:50}]}
            >
                       <IconRegistry icons={EvaIconsPack}/>
                        <ApplicationProvider {...eva} theme={eva.light}>
            ...
            >
                  <Text style={style.searchButtonText}>Clear</Text>     
            ...
            <ScrollView  style={style.scrollView} showsVerticalScrollIndicator={false}>
                ...
                ? <View style={style.emptyNoteContainer}>
                    ...
                    <Text style={style.emptyNoteText}>There is no Note Available</Text>
                </View>
                :
                props.notes.map((item,index)=>
                    <View style={style.item} key={index}>
                        ...
                        <View style={style.dateContainer}>
                         ...
                         >
                            <Text style={style.button.delete}>Edit</Text></TouchableOpacity>
                       </View>   
</View>
                )
                }
